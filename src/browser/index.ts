...
import {SpaceController} from "./component/space/SpaceController";
...
registerSystemController((system: System, entity: Entity, data: any) => new SpaceSystemController(system, entity, data));
